          ...
          const mobileLayout = (
            <div className="lg:hidden relative mb-6 ml-12">
              ...
              >
                ...
                <h3 className="text-cyan-400 text-xl font-medium mb-2">{ach.title}</h3>
                <p className=" text-white">{ach.issuer}</p>
                <p className='mb-1 text-sm text-white'>{ach.description}</p>
                <p className="text-xs text-white">{ach.year}</p>
                </div>
              </div>
            </div>
          );
